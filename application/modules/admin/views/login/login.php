        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="<?= base_url('assets/admin/assets/images/logo.png') ?>"
                                          alt="logo"/></span>
                </div>

                <? if ($username != '' AND $password != '') { ?>
                    <div class="text-danger" id="message"><?php echo $error; ?></div>
                <? } ?>
                    ...
                    <div class="row p-b-30">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?php echo $username; ?>" name="name" type="text"
